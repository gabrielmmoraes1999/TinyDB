...
public class JSONArray implements Iterable<Object> {
     ...
     * or double, the {@link BigDecimal#BigDecimal(double)} constructor will be
    ...
    /**
     * Removes all of the elements from this JSONArray. The JSONArray will be
     ...
     * is float or double, the {@link BigDecimal#BigDecimal(double)} constructor
     ...
     * @return this.
     *
     * @throws JSONException If not an array, JSONArray, Iterable or if an value
     ...
     * <p>
     * If
     * <pre> {@code indentFactor > 0}</pre> and the {@link JSONArray} has only
     ...
     * converted to a List and a Map respectively.
     * <p>
     * Warning: This method assumes that the data structure is acyclical.
     *
